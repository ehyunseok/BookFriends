...
>>>>>>> de1542043d23d26350fb0f2ac86d9c86ca687a0c
...
//모집글 댓글 작성
	public int writeRecruit(ReplyDto replyDto) {
		
		String SQL = "INSERT INTO reply VALUES (NULL, ?, null, ?, 0, ?, ?);";
...
// 댓글 리스트 불러오기
	public ArrayList<ReplyDto> getListRecruit(String recruitID) {
	    ArrayList<ReplyDto> replyList = null;
	    String SQL = "SELECT * FROM reply "
                + "WHERE recruitID = ? "
                + "ORDER BY replyDate DESC";
