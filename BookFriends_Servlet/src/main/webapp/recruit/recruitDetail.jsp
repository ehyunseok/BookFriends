...
<head>
    ...
    default-src 'self'; 
    script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net/npm https://cdnjs.cloudflare.com https://code.jquery.com; 
				...
				<div class="card-header bg-light">
					...
					<div class="btn-group dropright">
						<button id="goToChat" class="dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
								<h5 class="card-title"><img src="../images/icon.png" style="height:30px;"> <b><%= recruit.getUserID() %></b></h5>
						</button>
						<div class="dropdown-menu" aria-labelledby="dropdown">
							<a class="dropdown-item" href="../chat/chat2.jsp?receiverID=<%= recruit.getUserID() %>">채팅하기</a>
						</div>
					</div>
...
%>		
						<li class="list-group-item m-1">
							...
							<div class="btn-group dropright">
								...
								<div class="dropdown-menu" aria-labelledby="dropdown">
									<a class="dropdown-item" href="../chat/chat2.jsp?receiverID=<%= replyDto.getUserID() %>">채팅하기</a>
								</div>
							</div>
